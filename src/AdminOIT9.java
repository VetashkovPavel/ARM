...
public class AdminOIT9 extends JFrame {
    ...
    public AdminOIT9() throws IOException {
        ...
        butt1.addActionListener(new AdminOIT9.ActListenerping());
        butt1.addChangeListener(new AdminOIT9.ChngListener());
        ...
        butt2.addActionListener(new AdminOIT9.ActListIp());
        butt2.addChangeListener(new AdminOIT9.ChngListener());
        ...
        butt3.addActionListener(new AdminOIT9.ActListNod());
        butt3.addChangeListener(new AdminOIT9.ChngListener());
        ...
        butt41.addActionListener(new AdminOIT9.ActListTrial());
        butt41.addChangeListener(new AdminOIT9.ChngListener());
        ...
        butt5.addActionListener(new AdminOIT9.ActListAD());
        butt5.addChangeListener(new AdminOIT9.ChngListener());
        ...
        butt6.addActionListener(new AdminOIT9.ActListKSC());
        butt6.addChangeListener(new AdminOIT9.ChngListener());
        ...
        butt4.addActionListener(new AdminOIT9.ActListener());
        butt4.addChangeListener(new AdminOIT9.ChngListener());
        ...
        bolid.addActionListener(new AdminOIT9.ActListBolid());
        bolid.addChangeListener(new AdminOIT9.ChngListener());
        ...
        kerio.addActionListener(new AdminOIT9.ActListKerio());
    ...
    class ActListener implements ActionListener {
        public void actionPerformed(ActionEvent e) throws RuntimeException {
            JOptionPane.showMessageDialog(AdminOIT9.this,
    ...
    class ActListKerio implements ActionListener {
        public void actionPerformed(ActionEvent e) throws RuntimeException{
            ...
            try{JOptionPane.showMessageDialog(AdminOIT9.this,
    ...
    class ActListenerping implements ActionListener {
        public void actionPerformed(ActionEvent e) throws NullPointerException {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(AdminOIT9.this, " Пингуем хост " + field1.getText());
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (true) {
            try (ServerSocket srv = new ServerSocket(3030)) {
                Socket seventh = srv.accept();
                System.out.println("Соединение разрешено");
                DataOutputStream out = new DataOutputStream(seventh.getOutputStream());
                System.out.println("Поток записи создан");
                DataInputStream input = new DataInputStream(seventh.getInputStream());
